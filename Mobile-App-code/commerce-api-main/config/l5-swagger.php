...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Commerce Application Interface (API)',
            ],
    ...
    'defaults' => [
        ...
        'paths' => [
            ...
            */
            'base' => env('L5_SWAGGER_BASE_PATH', 'http://167.172.62.67'),
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://167.172.62.67'),
        ],
    ],
];
